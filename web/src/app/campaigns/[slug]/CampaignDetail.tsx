...
export default function CampaignDetail({ slug }: { slug: string }) {
  ...
  return (
    <>
      ...
      <h2>Export</h2>
      <div className="row">
        <ExportLink href={api.exportUrls.table(slug, "articles")}>Articles (CSV)</ExportLink>
        <ExportLink href={api.exportUrls.table(slug, "escalations")}>
          Escalations (CSV)
        </ExportLink>
        <ExportLink href={api.exportUrls.table(slug, "mentions")}>Mentions (CSV)</ExportLink>
        <ExportLink primary href={api.exportUrls.briefing([slug])}>
          One-page briefing
        </ExportLink>
      </div>
    </>
...
function PrePublicationDetail({ view }: { view: PrePublicationView }) {
  return (
    <>
      ...
      <h2>Export</h2>
      <ExportLink primary href={api.exportUrls.briefing([view.campaign.slug])}>
        One-page briefing
      </ExportLink>
    </>
  );
